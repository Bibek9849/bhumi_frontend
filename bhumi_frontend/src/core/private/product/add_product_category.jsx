...
import { useProductCategory } from "../../public/query.js";

const Layout = () => {
    const isDesktopDevice = useMediaQuery("(min-width: 768px)");
    const [collapsed, setCollapsed] = useState(!isDesktopDevice);
    const sidebarRef = useRef(null);
    const { mutate, isLoading, isError, error } = useProductCategory(); // Use mutation hook
                ...
                <div className="p-6 bg-white shadow-md rounded-lg m-4" onSubmit={handleSubmit(submit)}>
                    ...
                    <form className="bg-[#747f74] p-6 rounded-lg shadow-xl w-full max-w-md h-[400px] mt-10 shadow-[10px_8px_4px_0px_rgba(255, 253, 231, 0.8)]">
                        ...
                        <div className="mb-4">
                            ...
                            >
                                Name
                            </label>                        {errors.name && <p className="text-red-500">{errors.name.message}</p>}
                            ...
                            <input
                                ...
                                placeholder=""
                                required {...register("name", { required: "Product Name is required" })}
                            ...
                            <input
                                ...
                                className="shadow-sm bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder=""
                                required {...register("description", { required: "Description is required" })}
                            />
                        </div>
