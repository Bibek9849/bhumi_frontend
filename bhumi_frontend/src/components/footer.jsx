...
const Footer = () => {
    return (
        <footer class="bg-white rounded-lg shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-green-100 antialiased">
            <p class="mb-4 text-sm text-center text-black dark:text-black-400 sm:mb-0">
                &copy; <a href="/home" class="hover:underline" target="_blank">Bhumi</a>. All rights reserved.
            </p>
            <div class="flex justify-center items-center space-x-1">
                <a href="#" data-tooltip-target="tooltip-facebook" class="inline-flex justify-center p-2 text-black rounded-lg cursor-pointer dark:text-black-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
                ...
                <a href="#" data-tooltip-target="tooltip-twitter" class="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer dark:text-black-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
